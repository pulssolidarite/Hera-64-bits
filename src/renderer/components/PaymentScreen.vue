<template>
	<div id="payment-screen">
		...
		<div id="payment-tool">
			<div id="arrows">
				<img id="up-arrow" class="arrow" src="@/assets/img/fleche-haut-80x80px.svg" />
				<div class="invisible-box"></div>
				<img id="down-arrow" class="arrow" src="@/assets/img/fleche-bas-80x80px.svg" />
			</div>
			<div class="boxes">
			...
			<div class="outer-arrow"><img src="@/assets/img/fleche-droite-80x80px.svg"></div>
		</div>
...
import DonationInfos from "@/components/misc/DonationInfos.vue";
export default {
	name: "AmountChoice",
	components: {
		// AnimatedNumber,

	...
	<div id="campaign-selection">
		...
		<div class="instructions">
			<div class="inline-txt-img center-items">
				<div class="inline-img"><img src="@/assets/img/fleche-bas-80x80px.svg"></div>
				<div class="inline-txt">
					<div class="txt brown bold-font">voir sa vidéo</div>
				</div>
			</div>
			<div class="inline-txt-img center-items">
				<div class="inline-img"><img src="@/assets/img/bouton-A-80x80px.svg"></div>
				<div class="inline-txt">
					<div class="txt brown bold-font">choisir cette association</div>
				</div>
			</div>
			<div class="inline-txt-img center-items">
				<div class="inline-img"><img src="@/assets/img/bouton-X-80x80px.svg"></div>
				<div class="inline-txt">

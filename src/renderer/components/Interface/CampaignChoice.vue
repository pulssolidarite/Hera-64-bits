<template>
	<div class="component">
		<div class="view campaign-choice">
			...
			<div class="s-content">
				<div class="carousel">
					<vueper-slides ref="carousel" class="no-shadow" :infinite="false" :visibleSlides="1" :fixedHeight="true" :bullets="false" :touchable="false" :gap="30" transition-speed="250" @ready="chooseCampaign($event.currentSlide.index)" @slide="chooseCampaign($event.currentSlide.index)">
...
<template v-slot:content>
	<div class="carousel-content">
		...
		<div class="row picture">
			<youtube v-show="campaign.is_video" id="player-ytb" :video-id="campaign.video" :player-vars="playerVars" :fitParent="true" :ref="'youtube' + i" @ready="playerReady(i)" @playing="playerPlaying(i)" @ended="playVideo(i)" style="height: 100%; width: 100%;"></youtube>
	
			<img :src="campaign.logo" :alt="campaign.name" :class="[
	                        'slide-picture',

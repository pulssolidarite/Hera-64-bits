<template>
	<div id="error-modal" v-if="visible">
		<div id="infos" class="inline-txt-img center-items">
			<div class="inline-img"><img src="@/assets/img/picto-fail-325X260.svg"></div>
		...
		<div class="btn"><p class="big-font">sortir</p><img src="@/assets/img/fleche-noire.svg"><img src="@/assets/img/bouton-A-noir.svg"></div>
